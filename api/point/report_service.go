...
type ReportService interface {
	GetReport(ctx context.Context, from time.Time, to time.Time) ([]model.UserPoint, error)
}
...
func (s *BaseReportService) GetReport(ctx context.Context, from time.Time, to time.Time) ([]model.UserPoint, error) {
